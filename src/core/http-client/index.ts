...
export class HttpClient {
  ...
  private _buildAxiosRetryConfig(axiosRetryConfig?: AxiosRetryConfig) {
  ...
  private __logRetrying(retryCount: number, error: AxiosError, requestConfig: AxiosRequestConfig): void {
    const logger = this._createChildRequestLogger(
      (requestConfig as CustomAxiosRequestConfig).url,
      (requestConfig as CustomAxiosRequestConfig).requestId,
    )
